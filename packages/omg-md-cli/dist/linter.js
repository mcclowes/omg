...
exports.evaluateOalPropertyCasing = evaluateOalPropertyCasing;
exports.checkCasing = checkCasing;
exports.summarizeLintResults = summarizeLintResults;
 ...
 */
function evaluateOalPropertyCasing(target, options) {
    const doc = target;
    const blocks = (doc?.resolvedBlocks || doc?.blocks || []);
 ...
 */
function summarizeLintResults(file, results) {
    return {
        file,
        results,
