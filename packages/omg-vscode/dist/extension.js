...
function activate(context) {
    ...
    const clientOptions = {
        ...
        synchronize: {
            ...
            fileEvents: vscode_1.workspace.createFileSystemWatcher('**/.spectral-omg.yaml'),
        },
    };
    // Create and start the client
    client = new node_1.LanguageClient('omgLanguageServer', 'OMG Language Server', serverOptions, clientOptions);
