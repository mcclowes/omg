...
type Payment = {
  ...
  CurrencyRate?: number @format("double")  // Exchange rate when payment is received. Only used for non base currency invoices and credit notes e.g. 0.7500
  ...
  BankAmount?: number @format("double")  // The amount of the payment in the currency of the bank account.
  ...
  PaymentID?: uuid  // The Xero identifier for an Payment e.g. 297c2dc5-cc47-4afd-8ec8-74990b8761e9
  BatchPaymentID?: uuid  // Present if the payment was created as part of a batch.
  ...
  HasAccount?: boolean @default("false")  // A boolean to indicate if a contact has an validation errors
